/*  
 vu meter code modified from : https://forum.arduino.cc/index.php?topic=403234.0
 ...
 */
/*
 *  OLED SSD1306 I2C connection:
 *  VCC <----> 5v
 *  GND <----> GND
 *  SCL <----> A5 (UNO) / 21 (Mega2560)
 *  SDA <----> A4 (UNO) / 20 (Mega2560)
 * 
 * MAX-9812  Arduino
 *  VCC       5V
 *  GND       GND
...
// #include <SPI.h>                      // requried to run SPI
...
// from https://forum.arduino.cc/index.php?topic=403234.0
// VU meter background mask image:
// used Image2GLCD to convert the background mask to 128x64 and inserted it into the sketch. 
// Free download at: http://www.ablab.in/image2glcd-software/
...
void setup(){
  ...
  display.begin(SSD1306_SWITCHCAPVCC, 0x3C);               // needed for SSD1306 display, I2C address = 0x3C
...
************************************************************************/
  ...
  float MeterValue = ( PeaktoPeak * 5.0) / 1024 * 10;      // convert volts to arrow information
                                                           // using max9812 op-amp, fixed gain =20 dB = 10V at 5v
                                                           // convertion using : http://www.sengpielaudio.com/calculator-gainloss.htm
/****************************************************
